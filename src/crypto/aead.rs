...
mod tests {
    #[cfg(feature = "aws-lc")]
    use aws_lc_sys::{EVP_AEAD_key_length, EVP_AEAD_max_tag_len, EVP_AEAD_nonce_length};

    #[cfg(all(feature = "boring", not(feature = "aws-lc")))]
    use boring_sys::{EVP_AEAD_key_length, EVP_AEAD_max_tag_len, EVP_AEAD_nonce_length};
